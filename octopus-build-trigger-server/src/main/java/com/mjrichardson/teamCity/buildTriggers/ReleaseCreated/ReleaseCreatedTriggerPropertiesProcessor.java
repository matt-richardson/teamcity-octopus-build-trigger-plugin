...
class ReleaseCreatedTriggerPropertiesProcessor implements PropertiesProcessor {
    ...
    public ReleaseCreatedTriggerPropertiesProcessor(CacheManager cacheManager, MetricRegistry metricRegistry, BuildTriggerProperties buildTriggerProperties) {
        this(new OctopusConnectivityCheckerFactory(cacheManager), metricRegistry, buildTriggerProperties);
    }

    public ReleaseCreatedTriggerPropertiesProcessor(OctopusConnectivityCheckerFactory octopusConnectivityCheckerFactory, MetricRegistry metricRegistry, BuildTriggerProperties buildTriggerProperties) {
