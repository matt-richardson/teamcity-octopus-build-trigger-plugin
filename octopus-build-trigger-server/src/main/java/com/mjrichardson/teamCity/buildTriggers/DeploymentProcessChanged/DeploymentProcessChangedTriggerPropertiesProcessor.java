...
class DeploymentProcessChangedTriggerPropertiesProcessor implements PropertiesProcessor {
    ...
    public DeploymentProcessChangedTriggerPropertiesProcessor(OctopusConnectivityCheckerFactory octopusConnectivityCheckerFactory, MetricRegistry metricRegistry) {
