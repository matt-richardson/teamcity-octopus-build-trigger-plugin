...
class DeploymentProcessChangedTriggerPropertiesProcessor implements PropertiesProcessor {
    ...
    public DeploymentProcessChangedTriggerPropertiesProcessor(CacheManager cacheManager, MetricRegistry metricRegistry, BuildTriggerProperties buildTriggerProperties) {
        this(new OctopusConnectivityCheckerFactory(cacheManager), metricRegistry, buildTriggerProperties);
    }

    public DeploymentProcessChangedTriggerPropertiesProcessor(OctopusConnectivityCheckerFactory octopusConnectivityCheckerFactory, MetricRegistry metricRegistry, BuildTriggerProperties buildTriggerProperties) {
