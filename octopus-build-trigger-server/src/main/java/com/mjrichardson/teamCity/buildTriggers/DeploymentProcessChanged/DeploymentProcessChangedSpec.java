...
public class DeploymentProcessChangedSpec {
    @NotNull
    ...
    DeploymentProcessChangedSpec(@NotNull String url, @NotNull String newVersion, @NotNull String projectId) {
        this.url = url;
    ...
    public String getRequestorString() {
        return String.format("Deployment process of %s has changed to version %s on %s", projectId, version, url);
    }
