...
public class DeploymentCompleteAsyncBuildTrigger extends CustomAsyncBuildTrigger<DeploymentCompleteSpec> {
    ...
    public DeploymentCompleteAsyncBuildTrigger(String displayName, AnalyticsTracker analyticsTracker, CacheManager cacheManager, MetricRegistry metricRegistry, BuildTriggerProperties buildTriggerProperties) {
    ...
    @NotNull
    public CustomCheckJob<DeploymentCompleteSpec> createJob(@NotNull SBuildType buildType, @NotNull CustomDataStorage dataStorage, @NotNull Map<String, String> properties, @NotNull UUID correlationId) throws CheckJobCreationException {
