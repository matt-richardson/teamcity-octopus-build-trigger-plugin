...
class DeploymentCompleteTriggerPropertiesProcessor implements PropertiesProcessor {
    ...
    public DeploymentCompleteTriggerPropertiesProcessor(CacheManager cacheManager, MetricRegistry metricRegistry, BuildTriggerProperties buildTriggerProperties) {
        this(new OctopusConnectivityCheckerFactory(cacheManager), metricRegistry, buildTriggerProperties);
    }

    public DeploymentCompleteTriggerPropertiesProcessor(OctopusConnectivityCheckerFactory octopusConnectivityCheckerFactory, MetricRegistry metricRegistry, BuildTriggerProperties buildTriggerProperties) {
