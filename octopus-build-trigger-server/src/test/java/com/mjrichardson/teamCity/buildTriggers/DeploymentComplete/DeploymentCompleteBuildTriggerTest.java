...
public class DeploymentCompleteBuildTriggerTest {

    @Test
    public void get_name_returns_trigger_internal_name() throws Exception {
        DeploymentCompleteBuildTrigger sut = new DeploymentCompleteBuildTrigger(new FakePluginDescriptor(), new FakeAsyncBuildTriggerFactory());
    ...
    public void get_build_triggering_policy_returns_policy_provided_by_factory() throws Exception {
        ...
        DeploymentCompleteBuildTrigger sut = new DeploymentCompleteBuildTrigger(new FakePluginDescriptor(), new FakeAsyncBuildTriggerFactory(triggerPolicy));
