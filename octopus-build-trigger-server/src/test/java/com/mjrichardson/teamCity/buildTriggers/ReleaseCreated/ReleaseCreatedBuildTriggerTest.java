...
public class ReleaseCreatedBuildTriggerTest {

    @Test
    public void get_name_returns_trigger_internal_name() throws Exception {
        ReleaseCreatedBuildTrigger sut = new ReleaseCreatedBuildTrigger(new FakePluginDescriptor(), new FakeAsyncBuildTriggerFactory());
    ...
    public void get_build_triggering_policy_returns_policy_provided_by_factory() throws Exception {
        ...
        ReleaseCreatedBuildTrigger sut = new ReleaseCreatedBuildTrigger(new FakePluginDescriptor(), new FakeAsyncBuildTriggerFactory(triggerPolicy));
