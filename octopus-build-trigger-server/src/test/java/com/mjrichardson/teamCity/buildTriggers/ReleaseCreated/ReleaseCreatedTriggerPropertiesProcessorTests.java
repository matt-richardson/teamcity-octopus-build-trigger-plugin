...
public class ReleaseCreatedTriggerPropertiesProcessorTests {
    public void returns_error_when_url_is_null() {
        ReleaseCreatedTriggerPropertiesProcessor processor = new ReleaseCreatedTriggerPropertiesProcessor(new FakeCacheManager(), new FakeMetricRegistry());
    ...
    public void returns_error_if_connectivity_checker_returns_error() {
        ...
        ReleaseCreatedTriggerPropertiesProcessor processor = new ReleaseCreatedTriggerPropertiesProcessor(octopusConnectivityCheckerFactory, metricsRegistry);
        Map<String, String> properties = new HashMap<>();
        properties.put(OCTOPUS_APIKEY, "API-KEY");
        properties.put(OCTOPUS_PROJECT_ID, "project-id");
