...
public class FakeBuildType implements SBuildType {

    @Override
    public String toString() { return "the-build-type"; }
    ...
    public ValueResolver getValueResolver() {
        return new ValueResolver() {
            @NotNull
            @Override
            public ProcessingResult resolve(@NotNull String s) {
            ...
            @NotNull
            @Override
            public Map<String, String> resolve(@NotNull Map<String, String> map) {
                return null;
            }

            @NotNull
            @Override
            public Map<String, ProcessingResult> resolveWithDetails(@NotNull Map<String, String> map) {
                return null;
            }
        };
    }
