...
public class MachineAddedBuildTriggerServiceTest {
    ...
    public void get_name_returns_trigger_internal_name() throws Exception {
        MachineAddedBuildTriggerService sut = new MachineAddedBuildTriggerService(new FakePluginDescriptor(), new FakeAsyncBuildTriggerFactory(), new FakeAnalyticsTracker(), new FakeCacheManager(), new FakeMetricRegistry());
    ...
    public void get_build_triggering_policy_returns_policy_provided_by_factory() throws Exception {
        ...
        MachineAddedBuildTriggerService sut = new MachineAddedBuildTriggerService(new FakePluginDescriptor(), new FakeAsyncBuildTriggerFactory(triggerPolicy), new FakeAnalyticsTracker(), new FakeCacheManager(), new FakeMetricRegistry());
