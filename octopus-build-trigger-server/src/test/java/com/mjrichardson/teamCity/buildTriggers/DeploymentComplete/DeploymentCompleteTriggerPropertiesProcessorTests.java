...
public class DeploymentCompleteTriggerPropertiesProcessorTests {
    public void returns_error_when_url_is_null() {
        DeploymentCompleteTriggerPropertiesProcessor processor = new DeploymentCompleteTriggerPropertiesProcessor(new FakeCacheManager(), new FakeMetricRegistry(), new FakeBuildTriggerProperties());
    ...
    public void returns_error_if_connectivity_checker_returns_error() {
        ...
        DeploymentCompleteTriggerPropertiesProcessor processor = new DeploymentCompleteTriggerPropertiesProcessor(octopusConnectivityCheckerFactory, metricsRegistry, new FakeBuildTriggerProperties());
        Map<String, String> properties = new HashMap<>();
        properties.put(OCTOPUS_APIKEY, "API-KEY");
        properties.put(OCTOPUS_PROJECT_ID, "project-id");
