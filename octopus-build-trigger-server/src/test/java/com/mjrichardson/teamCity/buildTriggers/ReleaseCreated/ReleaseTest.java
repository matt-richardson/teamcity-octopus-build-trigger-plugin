...
public class ReleaseTest {
    public void can_parse_empty_string_to_null_release() throws NeedToDeleteAndRecreateTriggerException {
        Release sut = Release.Parse("");
        Assert.assertEquals(sut.getClass(), NullRelease.class);
    }

    public void can_parse_null_string_to_null_release() throws NeedToDeleteAndRecreateTriggerException {
        Release sut = Release.Parse((String)null);
        Assert.assertEquals(sut.getClass(), NullRelease.class);
    }

    public void can_parse_valid_string_to_release() throws NeedToDeleteAndRecreateTriggerException {
    ...
    public void parse_throws_exception_if_format_is_different() throws NeedToDeleteAndRecreateTriggerException {
    ...
    public void compare_returns_1_when_passed_release_has_newer_assembled_date() throws NeedToDeleteAndRecreateTriggerException {
    ...
    public void compare_returns_0_when_passed_release_has_same_assembled_date() throws NeedToDeleteAndRecreateTriggerException {
        Release release1 = Release.Parse("Releases-1;2016-01-21T13:32:59.991+00:00;1.0.0;Projects-1");
    ...
    public void compare_returns_minus_1_when_passed_release_has_older_assembled_date() throws NeedToDeleteAndRecreateTriggerException {
        Release release1 = Release.Parse("Releases-1;2016-01-21T13:32:59.991+00:00;1.0.0;Projects-1");
