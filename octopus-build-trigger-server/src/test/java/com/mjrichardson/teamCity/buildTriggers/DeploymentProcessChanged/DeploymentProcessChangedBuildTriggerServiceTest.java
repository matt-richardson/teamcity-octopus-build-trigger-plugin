...
public class DeploymentProcessChangedBuildTriggerServiceTest {
    ...
    public void get_name_returns_trigger_internal_name() throws Exception {
        DeploymentProcessChangedBuildTriggerService sut = new DeploymentProcessChangedBuildTriggerService(new FakePluginDescriptor(), new FakeAsyncBuildTriggerFactory(), new FakeAnalyticsTracker(), new FakeCacheManager(), new FakeMetricRegistry());
    ...
    public void get_build_triggering_policy_returns_policy_provided_by_factory() throws Exception {
        ...
        DeploymentProcessChangedBuildTriggerService sut = new DeploymentProcessChangedBuildTriggerService(new FakePluginDescriptor(), new FakeAsyncBuildTriggerFactory(triggerPolicy), new FakeAnalyticsTracker(), new FakeCacheManager(), new FakeMetricRegistry());
